...
class Communication:
    ...
    def send_private_message(
        ...
        """
        # print("*** INSIDE send_private_message")
        message_size = sys.getsizeof(message)
        self.sent_bytes += message_size
        # print(message_size)
    ...
    def retrieve_private_message(
        ...
        while True:
            ...
            if res.status_code == 200:
                # print("*** INSIDE retrieve_private_message")
                message_size = sys.getsizeof(res.content)
                self.received_bytes += message_size
                # print(message_size)
    ...
    def retrieve_public_message(
        ...
        while True:
            ...
            res = requests.get(url)
            if res.status_code == 200:
                # print("*** INSIDE retrieve_public_message")
                message_size = sys.getsizeof(res.content)
                self.received_bytes += message_size
                # print(message_size)
                return res.content
    ...
    def retrieve_beaver_triplet_shares(
        ...
        res = requests.get(url)
        # print("*** INSIDE retrieve_beaver_triplet_shares")
        message_size = sys.getsizeof(res.content)
        self.received_bytes += message_size
        # print(message_size)
